    ...
    <fragment>
        ...
        <c-generic-section top-divider>
            <div class="container-xs">
                ...
                <p>
                    Lorem ipsum dolor sit amet, <a href="#">consectetur adipiscing elit</a>, sed do eiusmod tempor
                ...
                <figure>
                    <c-image
                            ...
                            :width="712"
                            :height="400"/>
                    <figcaption class="text-color-low">A super-nice image <span role="img" aria-label="smile">😀</span>
                    </figcaption>
                </figure>
                <h4>Flexibility</h4>
                <p>
                    ...
                    aliquip ex ea commodo consequat sint occaecat cupidatat non proident, sunt in culpa qui officia
            ...
            <div class="container-xs">
                ...
                <div class="center-content">
                    <c-button
                            ...
                            @click="demoModalActive = true">Open modal
                    </c-button>
                </div>
