...
<script>
    ...
    import {SectionProps} from '@/plugins/SectionProps.js'
    ...
    export default {
        ...
        methods: {
                ...
                if (this.step == 3) {
                    ...
                    if (isValid) {
                        ...
                        this_app.recaptcha("signup").then((token) => {
                            ...
                            axios.post(process.env.VUE_APP_API_URL + '/onboarding/join', this_app.signup_params).then(response => {
            ...
            checkUsername() {
                ...
                this_app.recaptcha("checkusername").then((token) => {
                    ...
                    axios.post(process.env.VUE_APP_API_URL + '/onboarding/check_org_username', params).then(response => {
                        this_app.loading = false
            ...
            resentOTP() {
                ...
                this_app.recaptcha("resendotp").then((token) => {
                    ...
                    axios.post(process.env.VUE_APP_API_URL + '/onboarding/resend_otp', params).then(response => {
                        this_app.loading = false
            ...
            handleOnComplete(value) {
                ...
                this_app.recaptcha("sendotp").then((token) => {
                    ...
                    axios.post(process.env.VUE_APP_API_URL + '/onboarding/verify_otp', params).then(response => {
        ...
        mounted() {
            axios.get('https://ipinfo.io/json?token=91e704e7e4e225').then(response => {
